...
@ComponentScan(
		basePackageClasses = {
			   		org.godhc.restfulws.web.ComponentPackageMaker.class,
			   		org.godhc.restfulws.repository.ComponentPackageMaker.class,
			   		org.godhc.restfulws.service.ComponentPackageMaker.class,
			   		org.godhc.restfulws.component.ComponentPackageMaker.class }, 
...
public class RootContextConfig implements AsyncConfigurer, SchedulingConfigurer {
	...
	public Jaxb2Marshaller jaxb2Marshaller() {
		...
		marshaller.setPackagesToScan(new String[] { "org.davidservin.restfulws.utm.model" });
		return marshaller;
	}
